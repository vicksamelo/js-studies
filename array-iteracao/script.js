...
const cursos = document.querySelectorAll('.curso'); //isso é uma nodelist
...
const maioresQue100 = numbers.filter( n =>
  n > 100);
...
valorTotal = compras.reduce((acumulador, item) => {
  ...
  //o + na frente do item transforma a string em numero
  //o primeiro replace tira o R$
  //o segundo replace troca a virgula por ponto 
