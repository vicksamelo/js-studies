...
do prototype de Number. Number também possui alguns métodos.*/
...
/*abs() retorna o valor absoluto, ou seja, transforma negativo em positivo.ceil() 
arredonda para cima, retornando sempre uma integral e floor para baixo.
...
Math.floor(4.3); // 4
Math.round(4.8334); // 5 arredonda de acordo com as casas decimais
Math.round(4.3); // 4

/*max() retorna o maior número de uma lista de argumentos, min() o menor número
e random() um número aleatório entre 0 e 1. */
...
const random = Math.floor(Math.random() * (72 - 32 + 1)) + 32;
//Math.floor(Math.random() * (max - min + 1)) + min;

//--------------------------------------EXERCICIOS-------------------------------------------
// Retorne um número aleatório
// entre 1050 e 2000
const aleatorio3 = function () {
  return Math.round(Math.random() * (2000 - 1050 + 1) + 1050);
};

// Retorne o maior número da lista abaixo
const numeros = '4, 5, 20, 8, 9';

console.log(Math.max(4, 5, 20, 8, 9, 32, 15));
